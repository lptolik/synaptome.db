...
1. Sorokina, O., Mclean, C., Croning, M.D.R. et al.  *A unified resource and configurable model of the  synapse proteome and its role in disease*.  Sci Rep 11, 9967 (2021).<https://doi.org/10.1038/s41598-021-88945-7>.
...
t <- getPPIbyEntrez(presgp$HumanEntrez, type='induced') #obtain PPIs for the list of frequently found genes in presynaptc compartment
pander(head(t))
```
...
## 13.Export of PPI network as a table.
